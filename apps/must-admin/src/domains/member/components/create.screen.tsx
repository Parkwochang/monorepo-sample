...
import { useCreateAdminMember } from '../hooks';

// ----------------------------------------------------------------------

export const MemberCreateScreen = () => {
  const { form, onSubmit, isPending } = useCreateAdminMember();
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Input id={field.name} className="py-2 px-3" {...field} />
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Input id={field.name} className="py-2 px-3" type="password" {...field} />
                  <FormMessage />
                </FormItem>
              )}
            />
