  ...
  return (
    <main className="h-dvh grid place-items-center">
      <div className="text-center leading-normal flex flex-col gap-3">
        ...
        <p className="text-[88px]">{error.name}</p>
        <p className="text-2xl">요청하신 작업을 수행하지 못했습니다.</p>
        ...
        <div className="flex justify-center mt-5 gap-4">
          ...
          <button
            ...
            className="w-[200px] h-[60px] flex-center bg-a_mint text-white rounded-[12px] font-bold cursor-pointer"
          >
            새로고침
          </button>
        </div>
